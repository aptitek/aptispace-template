...
::: {.tab-actions}
* []{#btn-ram-start .bi-play-fill} Lancer Simulation
:::

::: {#btn-ram-start .tab-action data-target=".ram-storage-tabset" data-icon="play-fill"}
Lancer Simulation
:::
...
// 3. Rendu réactif du graphe d'accès mémoire
renderRamGraph = {
  createRamStorageGraph("ram-graph-container", storageMode, 'Salaire', ramTableData);
}
