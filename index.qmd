...
testSmGraph = {
  ...
  const nodes = [
    { id: "A", label: "Initial", fx: -120, fy: 0, status: "entry" }, // Le nœud A commence avec le statut "entry"
    { id: "B", label: "Traitement", fx: 0, fy: -80, status: "default" },
    { id: "C", label: "Analyse", fx: 0, fy: 80, status: "default" },
    { id: "D", label: "Terminé", fx: 120, fy: 0, status: "default" }
  ];

  const links = [
    { source: "A", target: "B", label: "flux_1", status: "default" },
    { source: "A", target: "C", label: "flux_2", status: "default" },
